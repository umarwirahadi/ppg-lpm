...
<div class="container-fluid mt-4">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="laporanForm" method="post" action="<?= site_url('admin/laporan/store') ?>" enctype="multipart/form-data">
                <div class="mb-3">
                    <label for="title" class="form-label">Judul Laporan <span class="text-danger">*</span></label>
                    <input id="title" name="title" type="text" class="form-control form-control-lg" required placeholder="Masukkan judul laporan">
                </div>

                <div class="mb-3">
                    <label for="description" class="form-label">Deskripsi</label>
                    <textarea id="description" name="description" class="form-control" rows="4" placeholder="Ringkasan atau keterangan singkat tentang laporan"></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <small id="fileHelp" class="form-text text-muted">Format: PDF atau DOCX. Ukuran maksimal disesuaikan oleh server.</small>
                </div>
