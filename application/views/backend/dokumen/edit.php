<div class="container-fluid mt-4">
    <div class="card">
        <div class="card-header d-flex align-items-center justify-content-between">
            <h4 class="mb-0">Edit Dokumen SPMI</h4>
            <a href="<?= site_url('admin/dokumen') ?>" class="btn btn-default btn-md">Kembali</a>
        </div>
        <div class="card-body">
            ...
            <form id="dokumenForm" method="post" action="<?= site_url('admin/dokumen/update/' . $dokumen->id) ?>" enctype="multipart/form-data">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="<?= site_url('admin/dokumen') ?>" class="btn btn-default btn-md">Batal</a>
                </div>
            </form>
        </div>
    </div>
